...
namespace BossSlayingTourney.Game.Controllers
{
    public class MainController : NetworkBehaviour
    {
        ...
        private BossSlayingTourney.Core.GameMode _gameMode;
        public BossSlayingTourney.Core.GameMode GameMode { get => _gameMode; set => _gameMode = value; }
        ...
        {
            if (_gameMode == BossSlayingTourney.Core.GameMode.Online && _networkManager.GetNetworkRunner().IsSharedModeMasterClient)
            {
            ...
            else if (_gameMode == BossSlayingTourney.Core.GameMode.Online)
            {
        ...
        private async UniTask DiceProgressAsync()
        {
            ...
            if ((GameMode == BossSlayingTourney.Core.GameMode.Online && CurrentTurnPlayerEntity != _userController.MyEntity) || CurrentTurnPlayerEntity.IsNpc)
            {
